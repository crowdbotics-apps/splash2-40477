  ...
  return <View style={styles.container}>
      ...
      <View style={styles.form}>
        <View style={styles.formField}>
          <Text style={styles.label}>What type of treats does {selectedPet?.name} like?*</Text>
        ...
        <View style={styles.formField}>
          <Text style={styles.label}>What type of food does {selectedPet?.name} like? *</Text>
      ...
      <View style={styles.funFactContainer}>
        <Text style={styles.funFact}>Fun fact: Don’t worry, you’ll be able to change these details at a later date</Text>
      </View>
