...
export const api_v1_petcategory_list = createAsyncThunk("petCategories/api_v1_petcategory_list", async payload => {
  const response = await apiService.api_v1_petcategory_list(payload);
  return response.data;
});
export const api_v1_petcategory_create = createAsyncThunk("petCategories/api_v1_petcategory_create", async payload => {
  const response = await apiService.api_v1_petcategory_create(payload);
  return response.data;
});
export const api_v1_petcategory_retrieve = createAsyncThunk("petCategories/api_v1_petcategory_retrieve", async payload => {
  const response = await apiService.api_v1_petcategory_retrieve(payload);
  return response.data;
});
export const api_v1_petcategory_update = createAsyncThunk("petCategories/api_v1_petcategory_update", async payload => {
  const response = await apiService.api_v1_petcategory_update(payload);
  return response.data;
});
export const api_v1_petcategory_partial_update = createAsyncThunk("petCategories/api_v1_petcategory_partial_update", async payload => {
  const response = await apiService.api_v1_petcategory_partial_update(payload);
  return response.data;
});
export const api_v1_petcategory_destroy = createAsyncThunk("petCategories/api_v1_petcategory_destroy", async payload => {
